...
**Massimo partecipanti** comprende membri e ospiti; raggiunto il limite le iscrizioni si fermano, senza obbligo di riempire tutti i posti. **Modifica torneo** è disponibile per ogni formula: il creatore modifica i propri tornei prima del cutoff, solo Jury può modificare anche quelli degli altri e intervenire a iscrizioni chiuse prima del sorteggio. Non si può ridurre il massimo sotto gli iscritti esistenti; dal primo iscritto formula, coppie e punteggio sono protetti. Cambiare data aggiorna il cutoff e può riaprire le iscrizioni. Dopo il sorteggio (o su tornei conclusi/annullati), Jury può correggere soltanto nome e circolo: tabellone, iscrizioni e risultati restano intatti.
