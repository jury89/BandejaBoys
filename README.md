...
- Su iPhone tutti i controlli delle form mantengono almeno `16px`, i modal non forzano il focus all’apertura e il viewport disabilita lo zoom: aprire o modificare uno slot non cambia più la scala della pagina.
