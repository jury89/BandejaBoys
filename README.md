...
- Pagelle post partita: dieci minuti dopo la fine di un campo prenotato, ogni titolare registrato riceve una notifica e trova nell’app una scheda per assegnare da 1 a 10 agli altri compagni registrati; gli eventuali ospiti senza account non vengono proposti. Il salvataggio conserva partita, autore, destinatario e timestamp; chi chiude la scheda la elimina definitivamente soltanto per sé. Nello storico di **I miei match**, ogni partita per cui il giocatore ha ricevuto almeno un voto mostra la relativa media su 10 nella mini scheda.
