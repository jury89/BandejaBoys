...
- Esportazione di ogni slot come evento `.ics` per aggiungerlo al calendario personale, con ora, durata, Oasi Boschetto e stato indicativo o confermato. Le azioni Calendario, Modifica ed Elimina usano icone compatte con etichette accessibili.
