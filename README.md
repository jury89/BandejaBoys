...
- Aggiunta di ogni slot al calendario personale scegliendo **Apple Calendar**, **Google Calendar** oppure **Outlook**. Apple riceve un file `.ics`; Google e Outlook aprono l’editor web con ora, durata, Oasi Boschetto e stato indicativo o confermato già compilati, così si può scegliere il calendario di destinazione. Le azioni Calendario, Modifica ed Elimina usano icone compatte con etichette accessibili.
