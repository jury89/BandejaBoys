...
- **Navigazione FantaBandeja**: una plancia interna separa **Gioca**, **Classifica** e **Risultati**, mostra i conteggi delle tre aree e lascia visibile un solo contenuto alla volta. I prossimi round includono sia le formazioni modificabili sia le partite già bloccate; lo storico cresce nella propria vista senza allungare le altre. Il regolamento completo resta disponibile dal pulsante “Come si gioca”.
