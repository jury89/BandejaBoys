...
- **Interfaccia Clubhouse mobile-first**: navigazione diretta Bacheca / Partite / Fanta / Statistiche, in basso sul telefono e in alto sul desktop. Gli slot mostrano una rosa compatta, il campo espandibile e lo stato personale separato dalla prenotazione; i filtri includono posti liberi e proprie iscrizioni (anche riserve). Le azioni gestionali hanno etichette nel menu “Altre azioni”. Partite personali prossime/giocate sono separate, lo storico si mostra a blocchi e il selettore delle statistiche permette la ricerca per nome. Logo e palette originali restano invariati. Dettagli in [docs/restyling.md](docs/restyling.md).
