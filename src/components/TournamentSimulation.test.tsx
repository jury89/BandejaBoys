...
describe('simulation UI isolation', () => {
  ...
  it('runs the timed rehearsal to the podium through UI without any remote calls', async () => {
    ...
    await u.click(screen.getByRole('button', { name: 'Salta all’inizio del torneo' }))
